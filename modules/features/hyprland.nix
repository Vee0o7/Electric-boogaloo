{
  ...
  flake.homeModules.hyprland = {
    ...
    wayland.windowManager.hyprland.settings = let
      ...
      movetoworkspacesilent = {n}: "exec, hyprctl dispatch movetoworkspacesilentsilent ${n}";
      ...
      scratchpad = {name}: "exec, hyprctl dispatch togglespecialworkspace ${name}";
    ...
    in {
      ...
      "$screenshot" = "hyprctl keyword animations:enabled 0 && ${lib.getExe pkgs.hyprshot} --freeze -m region && hyprctl keyword animations:enabled 1";
      ...
      bind = [
        ...
        "$mainMod, C, exec, noctalia msg panel-toggle clipboard"
        ...
        "$mainMod shift, code:20, ${scratchpad {name = "minimised";}}"
        "$mainMod, code:20, ${movetoworkspace {n = "special:minimised";}}"
      ];
