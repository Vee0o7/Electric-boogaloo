    ...
    systemd.user.services."rclone-proton.mount" = {
      ...
      Service = {
        ExecStart = "${pkgs.writeShellScript "watch-store" ''
          ...
          ${lib.getExe pkgs.rclone} mount proton: /home/viv/ProtonDrive --vfs-cache-mode writes --vfs-cache-max-size 500M --vfs-cache-max-age 1h --dir-cache-time 5m --allow-non-empty --log-level INFO --umask 002 --allow-other ''}";
